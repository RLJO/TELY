...

{
    ...
    'version': '12.0.0.7',
    'category': 'Industries',
    'summary': 'This module help Car/Spar-part Repair Servicing any kind of product Repair management.',
    "description": """
...
* * Après Workorder *: Une facture préliminaire est créée et doit être payée après la fin du travail.
    ...
    'depends': ['base','sale_management','stock','project','account','website','website_sale','document','hr_timesheet','fleet'],
    'data': [
