    ...
    ActionManager.include({
        _executeReportAction: function (action, options) {
            ...
            if (action.report_type === "controller") {
                url = "/report/odt_to_x/" + action.report_name;
            }
            ...
            if ((action.report_type === "qweb-pdf" || action.report_type === "controller") && session.preview_print) {
            ...
            if ((action.report_type === "qweb-pdf" || action.report_type === "controller") && session.automatic_printing) {
            ...
            if ((!session.automatic_printing && !session.preview_print) || (action.report_type != "qweb-pdf" && action.report_type != "controller")) {
