...
version 12.0.1.0
	--> Product name displayed correct in purchase order, receipts and vendor bill when created from material requisition	
	--> Solved issue generating while creating picking from purchase requisition.
