...
class import_bsl_wizard(models.TransientModel):
    ...
    def validate_field_many2many(self, field_name, field_ttype, field_value, field_required, field_name_m2o):
        ...
        if field_required and field_value in (None,""):
            ...
            name_relational_model = self.env['account.bank.statement.line'].fields_get()[field_name]['relation']     
...
#         else:
    ...
    def validate_field_selection(self, field_name, field_ttype, field_value, field_required, field_name_m2o):
        ...
        selection_key_value_list = self.env['account.bank.statement.line'].sudo()._fields[field_name].selection
    ...
    def show_success_msg(self,counter,skipped_line_no):
        ...
        action = self.env.ref('sh_import_bsl.sh_import_bsl_action').read()[0]
